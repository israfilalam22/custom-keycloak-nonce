        ...
        <div class="${properties.kcFormGroupClass!} no-bottom-margin">
            ...
            <div id="kc-form">
                <div id="kc-form-wrapper">
                    <#if realm.password>
			<form id="kc-form-login" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post" hidden>
                            <#if !usernameHidden??>
		    ...
		    <div id="kc-form-passkey-button" class="${properties.kcFormButtonsClass!}" hidden>
        ...
        <script nonce="${cspNonce}" type="module">
            ...
            document.addEventListener("DOMContentLoaded", (event) => initAuthenticate(args, (available) => {
                if (available) {
                    ...
                    document.getElementById("kc-form-passkey-button").hidden = false;
                }
            }));
            </#outputformat>
        </script>
