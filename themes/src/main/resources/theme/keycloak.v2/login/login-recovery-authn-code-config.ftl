...
<@layout.registrationLayout; section>
    ...
    <#elseif section = "form">
        ...
        <div class="${properties.kcRecoveryCodesActions!}">
            <button id="printRecoveryCodes"
                    class="${properties.kcButtonLinkClass}"
                    type="button">
                <i class="fas fa-print"></i>
                ${msg("recovery-codes-print")}
            </button>

            <button id="downloadRecoveryCodes"
                    class="${properties.kcButtonLinkClass}"
                    type="button">
        ...
        <div class="${properties.kcFormOptionsClass!} pf-v5-u-mt-md">
            <input class="${properties.kcCheckInputClass!}"
                   type="checkbox"
        ...
        <script nonce="${cspNonce}">
            <#outputformat "JavaScript">
                ...
                function parseRecoveryCodeList() {
                    const recoveryCodes = document
                        .getElementById("kc-recovery-codes-list")
                ...
                function buildDownloadContent() {
                    ...
                    return fileBodyContent =
                        ...
                        ${msg("recovery-codes-download-file-date")?c} + " " +
                ...
                function buildPrintContent() {
                    const recoveryCodeListHTML =
                        document.getElementById("kc-recovery-codes-list")
                    ...
                    return printFileContent =
                        "<html><style nonce='${cspNonce}'>" + styles + "</style><body>" +
                ...
                document
                    .getElementById("printRecoveryCodes")
                    .addEventListener("click", printRecoveryCodes);

                document
                    .getElementById("downloadRecoveryCodes")
                    .addEventListener("click", downloadRecoveryCodes);

                document
                    .getElementById("copyRecoveryCodes")
                    .addEventListener("click", copyRecoveryCodes);

                document
                    .getElementById("kcRecoveryCodesConfirmationCheck")
