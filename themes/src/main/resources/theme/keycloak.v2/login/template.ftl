...
<head>
    ...
    <script nonce="${cspNonce}" type="importmap">
        {
            "imports": {
    ...
    <#if darkMode>
      <script nonce="${cspNonce}" type="module" async blocking="render">
...
<script nonce="${cspNonce}" type="module">
    const resetLoginButton = document.getElementById("reset-login");

    if (resetLoginButton) {
        resetLoginButton.addEventListener("click", () => {
            window.location.href = resetLoginButton.dataset.loginRestartUrl;
        });
    }
    ...
    document.querySelectorAll("a[data-form-id]").forEach((element) => {
      ...
      <div class="${properties.kcLoginMainBody!}">
        ...
        <#if auth?has_content && auth.showTryAnotherWayLink()>
          <form id="kc-select-try-another-way-form" action="${url.loginAction}" method="post" novalidate="novalidate">
              ...
              <a id="try-another-way" href="#" data-form-id="kc-select-try-another-way-form"
        ...
        <#if switchOrganizationEnabled?? && switchOrganizationEnabled>
          <form id="kc-switch-organization-form" action="${url.loginAction}" method="post" novalidate="novalidate">
              ...
              <a id="switch-organization" href="#" data-form-id="kc-switch-organization-form"
                  class="${properties.kcButtonSecondaryClass} ${properties.kcButtonBlockClass} ${properties.kcMarginTopClass}">
